  ...
  <div class="container py-5" id="project-form" style="max-width: 800px">
      <form action="{{ route('projects.update', ['project' => $project->project_id]) }}" method="POST">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input class="form-control" type="text" name="category" id="category" value="{{ $project->category }}">
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input class="form-control" type="number" name="cost" id="cost" value="{{ $project->cost }}">
          </div>
        </div>
